...
<div class="row">
    <div class="col-md-6 col-sm-6 col-xs-6">
        <a href="{{ route('social.redirect', ['provider' => 'google']) }}" class="btn-floating btn-small btn-gplus"><i class="fa fa-google-plus"> </i></a>
    </div>
    <div class="col-md-6 col-sm-6 col-xs-6">
        <a href="{{ route('social.redirect', ['provider' => 'facebook']) }}" class="btn-floating btn-small btn-fb"><i class="fa fa-facebook"> </i></a>
    </div>
</div>
<!-- 
        <div class="col-md-6 col-sm-6 col-xs-6">
